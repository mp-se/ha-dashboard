...
describe('useEntityResolver', () => {
  ...
  describe('String entity ID resolution', () => {
    it('should resolve entity by string ID', () => {
      const mockEntity = { entity_id: 'sensor.temperature', state: '20', attributes: { friendly_name: 'Temperature' } };
      const mockStore = {
        sensors: [mockEntity],
      };
    ...
    it('should return null for unknown entity ID', () => {
      const mockStore = {
        sensors: [{ entity_id: 'sensor.temperature', state: '20', attributes: {} }],
      };
      useHaStore.mockReturnValue(mockStore);
  ...
  describe('Object entity resolution', () => {
    it('should use object directly when passed as entity', () => {
      const mockStore = { sensors: [] };
      useHaStore.mockReturnValue(mockStore);
      const mockEntity = { entity_id: 'sensor.test', state: '42', attributes: {} };
  ...
  describe('isAvailable computed', () => {
    ...
    it('should return false when entity is unavailable', () => {
      const mockStore = {
        sensors: [{ entity_id: 'sensor.test', state: 'unavailable', attributes: {} }],
      };
      useHaStore.mockReturnValue(mockStore);
    ...
    it('should return false when entity is unknown', () => {
      const mockStore = {
        sensors: [{ entity_id: 'sensor.test', state: 'unknown', attributes: {} }],
      };
      useHaStore.mockReturnValue(mockStore);
  ...
  describe('friendlyName computed', () => {
    it('should return friendly_name from attributes', () => {
      const mockStore = {
        sensors: [{ entity_id: 'sensor.test', state: '42', attributes: { friendly_name: 'Test Sensor' } }],
      };
      useHaStore.mockReturnValue(mockStore);
  ...
  describe('entityId computed', () => {
    ...
    it('should extract entity_id from object input', () => {
      const mockStore = { sensors: [] };
      useHaStore.mockReturnValue(mockStore);
      const mockEntity = { entity_id: 'sensor.object_test', state: '42', attributes: {} };
  ...
  describe('Return object structure', () => {
    it('should return all required properties', () => {
      const mockStore = {
        sensors: [{ entity_id: 'sensor.test', state: '42', attributes: { friendly_name: 'Test' } }],
      };
      useHaStore.mockReturnValue(mockStore);
    ...
    it('should return computed properties', () => {
      ...
      const { resolvedEntity, isAvailable, friendlyName, entityId } = useEntityResolver('sensor.test');
