...
describe("useIconCircleColor", () => {
  ...
  describe("Temperature sensors", () => {
    ...
    it("should handle temperature boundaries", () => {
      expect(
        useIconCircleColor(
          { state: "15", attributes: { device_class: "temperature" } },
          "sensor.temp",
        ),
      ).toBe("#28a745");
      expect(
        useIconCircleColor(
          { state: "22", attributes: { device_class: "temperature" } },
          "sensor.temp",
        ),
      ).toBe("#28a745");
      expect(
        useIconCircleColor(
          { state: "28", attributes: { device_class: "temperature" } },
          "sensor.temp",
        ),
      ).toBe("#fd7e14");
    });
  ...
  describe("Voltage sensors - 220V/240V outlets", () => {
    it("should return green for normal 220V (210-250V)", () => {
      ...
      expect(useIconCircleColor(entity, "sensor.voltage_phase1")).toBe(
        "#28a745",
      );
    });
  ...
  describe("Voltage sensors - 12V DC battery", () => {
    it("should return green for normal 12V battery (12-14.5V)", () => {
      ...
      expect(useIconCircleColor(entity, "sensor.battery_voltage")).toBe(
        "#28a745",
      );
    });
    ...
    it("should detect 12V battery by entity name pattern", () => {
      ...
      expect(useIconCircleColor(entity, "sensor.libatt_battery_voltage")).toBe(
        "#28a745",
      );
    });
  });
  ...
  describe("Voltage sensors - 24V DC battery", () => {
    it("should return green for normal 24V battery (24-29V)", () => {
      ...
      expect(useIconCircleColor(entity, "sensor.battery_24v_voltage")).toBe(
        "#28a745",
      );
    });
  ...
  describe("Voltage sensors - edge cases", () => {
    it("should return grey for unknown voltage range", () => {
      ...
      expect(useIconCircleColor(entity, "sensor.unknown_voltage")).toBe(
        "#6c757d",
      );
    });
    ...
    it("should handle voltage with volt unit variant", () => {
      const entity = {
        state: "230",
        attributes: { unit_of_measurement: "volt" },
      };
      expect(useIconCircleColor(entity, "sensor.voltage")).toBe("#28a745");
    });
  ...
  describe("State-based entities", () => {
    ...
    it("should handle device_tracker domain", () => {
      ...
      expect(useIconCircleColor(entity, "device_tracker.phone")).toBe(
        "#28a745",
      );
    });
  });
