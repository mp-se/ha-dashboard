 ...
 * @param {Array<{value: number}>} chartData - Current period data
 * @param {Array<{value: number}>} prevChartData - Previous period data for comparison
 * @returns {object} Statistics object
 */
export function calculateStats(chartData, prevChartData) {
 ...
 * @returns {number} Scaled max value for Y-axis
 */
export function calculateMaxValue(maxValue) {
 ...
 * @returns {number} Step value for labels
 */
 ...
 * @param {import('vue').Ref<Array>} chartData - Chart data array
 * @param {import('vue').Ref<Array>} prevChartData - Previous period data
 * @returns {object} Chart utilities and computed values
 */
export function useEnergyChart(chartData, prevChartData) {
