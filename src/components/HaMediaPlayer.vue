    ...
    >
      ...
      >
        ...
        <template v-else>
          ...
          <!-- Media Info -->
          <div
            v-if="mediaTitle || mediaArtist"
            class="media-info mb-2 text-start"
          >
            <div v-if="mediaTitle" class="fw-bold small">{{ mediaTitle }}</div>
            <div v-if="mediaArtist" class="text-muted small">
              {{ mediaArtist }}
            </div>
          </div>
          ...
          <!-- Volume and Source -->
          <div
            v-if="volumeLevel !== undefined || source"
          ...
          <div v-if="isControllable" class="d-flex flex-wrap gap-2 mb-2">
            <button
              :class="[
                'btn btn-sm',
                isOn ? 'btn-outline-success' : 'btn-outline-secondary',
              ]"
              title="Power Toggle"
