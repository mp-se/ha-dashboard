...
describe('PropertyEditorFactory.vue', () => {
  ...
  describe('Text Input', () => {
    ...
    it('emits update:modelValue from TextInput', async () => {
      ...
      await wrapper.findComponent(TextInput).vm.$emit('update:modelValue', 'new');
  ...
  describe('Textarea Input', () => {
    it('renders TextAreaInput for textarea property type', () => {
      ...
      expect(wrapper.findComponent(TextAreaInput).props('label')).toBe('Description');
    });
    ...
    it('emits update:modelValue from TextAreaInput', async () => {
      ...
      await wrapper.findComponent(TextAreaInput).vm.$emit('update:modelValue', 'new desc');
  ...
  describe('Select Input', () => {
    it('renders SelectInput for select property type', () => {
      ...
      expect(wrapper.findComponent(SelectInput).props('options')).toEqual(property.options);
    });
    ...
    it('emits update:modelValue from SelectInput', async () => {
      ...
      await wrapper.findComponent(SelectInput).vm.$emit('update:modelValue', 'b');
  ...
  describe('Boolean Toggle', () => {
    it('renders BooleanToggle for boolean property type', () => {
      ...
      expect(wrapper.findComponent(BooleanToggle).props('label')).toBe('Enabled');
    });
    ...
    it('emits update:modelValue from BooleanToggle', async () => {
      ...
      await wrapper.findComponent(BooleanToggle).vm.$emit('update:modelValue', false);
  ...
  describe('Entity List Editor', () => {
    ...
    it('emits update:modelValue from EntityListEditor', async () => {
      ...
      await wrapper.findComponent(EntityListEditor).vm.$emit('update:modelValue', ['entity2']);
  ...
  describe('Icon Picker', () => {
    ...
    it('emits update:modelValue from IconPicker', async () => {
      ...
      await wrapper.findComponent(IconPicker).vm.$emit('update:modelValue', 'mdi-star');
  ...
  describe('Color Picker', () => {
    ...
    it('emits update:modelValue from ColorPicker', async () => {
      ...
      await wrapper.findComponent(ColorPicker).vm.$emit('update:modelValue', '#00ff00');
  ...
  describe('Number Input', () => {
    ...
    it('emits update:modelValue from NumberInput', async () => {
      ...
      await wrapper.findComponent(NumberInput).vm.$emit('update:modelValue', 75);
  ...
  describe('Error handling', () => {
    it('passes error prop to all components', () => {
      ...
      expect(wrapper.findComponent(TextInput).props('error')).toBe('Required field');
    });
  });
