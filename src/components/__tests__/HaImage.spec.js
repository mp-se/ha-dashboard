...
describe("HaImage.vue", () => {
  ...
  describe("URL Resolution", () => {
    ...
    it("should handle nested relative paths", () => {
      ...
      expect(img.attributes("src")).toContain(
        "data/subfolder/nested/image.jpg",
      );
    });
  ...
  describe("Breadth Coverage", () => {
    ...
    it("should handle long URLs", () => {
      const longUrl =
        "https://example.com/very/long/path/to/image/with/many/segments/photo.jpg?param1=value1&param2=value2&param3=value3";
      const wrapper = mount(HaImage, {
        props: {
          url: longUrl,
        },
    ...
    it("should handle URLs with query parameters", () => {
      const urlWithParams =
        "https://example.com/image.jpg?width=800&height=600&quality=95";
      const wrapper = mount(HaImage, {
        props: {
          url: urlWithParams,
        },
