        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">
              ...
              <span>{{
                showInstallButton ? "Install app" : "Install on iPhone/iPad"
              }}</span>
            </h5>
            <button
              type="button"
          ...
          <div class="modal-body">
            <div v-if="showInstallButton">
              <p>
                Add this dashboard to your device for a fullscreen experience
                and quick access.
              </p>
              <div v-if="!deferredPrompt" class="alert alert-warning mt-2">
                <small
                  >Programmatic installation is not available in this browser.
                  Please use your browser's menu or settings to install the app
                  manually.</small
                >
              </div>
            </div>
...
const pwaPrompt = window.__appCapabilities?.pwaPrompt ?? true;
...
const showModal = () => {
  if (!pwaPrompt || isInstalled.value || store.isLocalMode) return;
