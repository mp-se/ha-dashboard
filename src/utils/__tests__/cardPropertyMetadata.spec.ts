...
import { getCardProperties, validateProperty, CARD_PROPERTY_METADATA } from '../cardPropertyMetadata';
...
describe('cardPropertyMetadata.ts', () => {
  ...
  describe('validateProperty', () => {
    ...
    it('rejects invalid operator', () => {
      ...
      const result = validateProperty('HaWarning', 'operator', 'invalid_operator');
      expect(result.valid).toBe(true); // Currently allows any value
    });

    it('validates message property', () => {
      const result = validateProperty('HaWarning', 'message', 'This is a warning');
      expect(result.valid).toBe(true);
    });
