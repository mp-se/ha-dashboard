...
describe("RawEntityView.vue", () => {
  ...
  it("renders the filter controls", () => {
    ...
    expect(wrapper.find('input[placeholder*="Filter by name"]').exists()).toBe(
      true,
    );
  ...
  it("filters entities by search text", async () => {
    ...
    store.sensors = [
      ...
      },
      {
        ...
        state: "1013",
        attributes: { friendly_name: "Pressure" },
      },
    ];
  ...
  it("filters entities by search on entity_id", async () => {
    ...
    store.sensors = [
      ...
      },
      {
        entity_id: "sensor.humidity",
        state: "60",
        attributes: { friendly_name: "Hum" },
      },
      {
        entity_id: "sensor.pressure",
        state: "1013",
        attributes: { friendly_name: "Press" },
      },
    ];
    ...
    store.sensors = [
      {
        ...
        state: "on",
        attributes: { friendly_name: "Named Sensor" },
      },
  ...
  describe("Generate Config Functionality", () => {
    ...
    it("shows message when no supported entities found", async () => {
      ...
      expect(wrapper.vm.successBanner).toBe(true);
      expect(wrapper.vm.successBannerMessage).toContain(
