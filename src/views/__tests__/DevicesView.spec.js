...
describe('DevicesView.vue', () => {
  ...
  describe('Area filtering', () => {
    it('renders area select dropdown', () => {
      const wrapper = mount(DevicesView);
      const select = wrapper.find('select[aria-label="Filter devices by area"]');
    ...
    it('filters devices by selected area', async () => {
      ...
      store.devices = [
        ...
        { id: 'device3', name: 'Coffee Maker', area_id: 'kitchen', entities: [] },
      ];
    ...
    it('filters unassigned devices when "Unassigned" is selected', async () => {
      ...
      store.devices = [
        { id: 'device1', name: 'Device with area', area_id: 'kitchen', entities: [] },
    ...
    it('displays "Unassigned" for device without area', () => {
      const store = useHaStore();
      store.devices = [
        { id: 'device1', name: 'Device', entities: [] },
      ];
  ...
  describe('Copy to clipboard functionality', () => {
    ...
    it('copy button is clickable', async () => {
      const store = useHaStore();
      store.devices = [
        { id: 'device1', name: 'Test Device', entities: [] },
      ];
      store.areas = [];
      store.sensors = [];
  ...
  describe('Combined filtering (area + search)', () => {
    it('filters devices by both area and search text', async () => {
      ...
      store.devices = [
        { id: 'device1', name: 'Philips Hue Light', area_id: 'kitchen', entities: [] },
        { id: 'device2', name: 'Sonos Speaker', area_id: 'kitchen', entities: [] },
        { id: 'device3', name: 'Philips Lamp', area_id: 'bedroom', entities: [] },
      ];
    ...
    it('shows no devices when area and search filters do not match', async () => {
      ...
      const cards = wrapper.findAll('.card');
      expect(cards.length).toBe(0);
      expect(wrapper.text()).toContain('No devices found matching your filters');
    });
  });
